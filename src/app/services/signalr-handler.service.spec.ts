...
describe('SignalrHandlerService', () => {
    ...
    beforeEach(() => {
        ...
        browserNotificationService = jasmine.createSpyObj('BrowserNotificationService', ['showNotification']);
        ...
        TestBed.configureTestingModule({
            providers: [
                ...
                { provide: BrowserNotificationService, useValue: browserNotificationService },
            ],
        });
